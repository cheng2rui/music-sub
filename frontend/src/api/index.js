...
export const resolveOnlineSong = (song) => json(authFetch('/api/online/resolve', {
  method: 'POST',
...
export const refreshWechatClawQrcode = () => authFetch('/api/notify/wechatclaw/qrcode', { method: 'POST' }).then(r => r.json())
export const restartWechatClaw = () => authFetch('/api/notify/wechatclaw/restart', { method: 'POST' }).then(r => r.json())
export const logoutWechatClaw = () => authFetch('/api/notify/wechatclaw/logout', { method: 'POST' }).then(r => r.json())
